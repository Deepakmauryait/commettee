                  ...
                  <div class="col-sm-3">
                           ...
                           <div class="row">
                              ...
                              <div class="col-sm-8"> 
                                 ...
                                 <a class="badge bg-primary text-white" href="<?php echo base_url()?>">View</a>
                              </div>
                           </div>
                  ...
                  <div class="col-sm-6">
                     <div class="card">
                        <h5 class="card-header bg-success text-white border-bottom p-1">Delivery Address 
                          <input type="checkbox" name="same_billing" id="same_billing" value="yes"> <small>Same as billing</small></h5>
                        <div class="card-body p-1">
                      ...
                      <tfoot class="table-light">
                        <tr>
                          ...
                          <td><span class="totalCart">00</span>
                            ...
                            <input type="hidden" name="total" id="total" value="0"></td>
                        </tr>
                      </tfoot>
                    </table>
                    </div>
