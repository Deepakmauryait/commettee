...
class Front_model extends Base_model
{
    ...
    public $table = "z_front_data";

    //set column field database for datatable orderable
    var $column_order = array(null,null, 'contentHead', 'contentText','contentImage','status','date_at'); 

    //set column field database for datatable searchable 
    var $column_search = array('contentHead','contentText'); 
