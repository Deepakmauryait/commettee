        ...
        <div class="row">
            <div class="row">
                ...
                <?php
                    ...
                    {
                ?>
                <div class="alert alert-danger alert-dismissable" id="messege">
                ...
                <?php  
                    ...
                    {
                ?>
                <div class="alert alert-success alert-dismissable" id="messege">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                ...
                <script type="">
                  setTimeout(function(){ $('#messege').hide();},3000);
                </script>
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo base_url('admin/dashboard/jury_ajax_list')?>",
            "type": "POST"
        },
     ...
     jQuery(document).on("click", ".deletebtn", function(){
          ...
          var userId = $(this).data("userid"),
            hitURL = "<?php echo base_url() ?>admin/dashboard/jurydelete",
            currentRow = $(this);
...
<!-- <script type="text/javascript">
         ...
         jQuery(document).on("change", ".statusBtn", function(){
          ...
          if(userId && value)
          {
            ...
            hitURL = "<?php echo base_url()?>admin/dashboard/jurystatusChange",
            currentRow = $(this);
            jQuery.ajax({
            type : "POST",
            dataType : "json",
