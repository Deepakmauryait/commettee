                    ...
                    <div class="d-flex ">
                        ...
                        <div class="navbar-brand-box ">
                            ...
                            <a href="<?php echo base_url(); ?>admin" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="<?php echo base_url(); ?>assets/images/logodelhii.jpg" alt="" style="border-radius:50px; margin-left: -10px;" height="40">
                                </span>
                                <span class="logo-lg">
                                    <img src="<?php echo base_url(); ?>assets/images/logodelhii.jpg" alt="" height="80" style="border-radius:50%; margin-top:20px;">
                                </span>
                            </a>
                        </div>
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled mt-4" id="side-menu">
                            ...
                            <li>
                                <a href="<?php echo base_url();?>admin/dashboard/jurylist" class="waves-effect">
                                    
                                    <span key="t-ecommerce">Jury Member list</span>
                                </a>
